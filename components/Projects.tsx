...
import { reactTube, jacked, y, dashboard, filmpire } from '@/public/assets'
      ...
      <div className='w-full flex flex-col items-center justify-between gap-28 mt-10'>
        ...
        >
          <div className='flex flex-col xl:flex-row gap-6'>
            <a
              href="https://venerable-filmpire.netlify.app/"
              target='_blank'
            ...
            <div className='w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-between items-end text-right xl:-ml-16 z-10'>
              ...
              <p className='bg-[#112240] text-sm md:text-base p-2 md:p-6 rounded-md'>
                Filmpire is a movie database application that allows users to search for movies, view details about them, and save them to their watchlist. Built with <span className='text-textGreen'>React</span> and <span className='text-textGreen'>redux</span>, utilizing the newest features of <span className='text-textGreen'>NextJS</span>. This full-stack app implements <a href='https://alan.app/' target='_blank'><span className='text-textGreen underline'>Alan AI</span></a> to have access to a smart assistant that helps you navigate the app.<a href='https://www.themoviedb.org/' target='_blank'><span className='text-textGreen underline'>The Movie Database API</span></a> for movie data, and <a href='https://material-ui.com/' target='_blank'><span className='text-textGreen underline'>Material UI</span></a> for a clean looking user interface.
              </p>
              ...
              <div className='text-2xl flex gap-4'>
                <a
                  href="https://github.com/lucascomamala/filmpire"
                  target='_blank'
